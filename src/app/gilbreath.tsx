...
function CardChip({ card, size = 'md' }: { card: Card; size?: 'sm' | 'md' }) {
  ...
  return (
    ...
    >
      <span style={{ fontSize: fSuit, color: isRed ? '#f87171' : '#64748b', lineHeight: 1 }}>
        {card.suit}
      </span>
      <span
        style={{
...
function PairBox({ result, index }: { result: ShuffleResult['pairs'][number]; index: number }) {
  return (
    <div
      style={{
        display: 'flex',
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <p style={{ fontSize: '0.85rem', color: '#888', letterSpacing: '0.1em' }}>
      ...
      >
        ...
        <div style={{ fontSize: '1.4rem', color: '#334', userSelect: 'none' }}>⇄</div>
      ...
      {latest && (
        ...
        >
          ...
          >
            ...
            >
              {latest.pairs.filter(p => p.valid).length}/{latest.pairs.length} paires valides
              {'  '}
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: '1rem', fontWeight: 600, color: '#ff6b6b' }}>
              max — aléatoire
            </div>
          </div>
          <div>
            ...
            <div style={{ fontSize: '1rem', fontWeight: 600, color: '#4ecdc4' }}>
              nulle — contrôlée
            </div>
          </div>
        </div>
        ...
        >
          L'écart entre ces deux entropies est l'essence du tour — et de la cryptographie.
        </div>
      </div>
        ...
        >
          ...
          <div style={{ fontSize: '0.85rem', lineHeight: 1.85, color: '#bbb' }}>
            <p style={{ marginBottom: '1rem' }}>
              <strong style={{ color: '#4ecdc4' }}>Préparation :</strong> les deux demi-paquets
              sont des miroirs — chaque carte{' '}
              <code
                style={{
            ...
            <p style={{ marginBottom: '1rem' }}>
              <strong style={{ color: '#4ecdc4' }}>Preuve :</strong> lors du mélange, on consomme
              les cartes des deux paquets. À chaque instant, les "fronts" des deux paquets restants
              sont toujours de couleurs opposées — l'invariant se propage.
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
              <strong style={{ color: '#4ecdc4' }}>Lien informatique :</strong> c'est un{' '}
              <em>checksum structurel</em>. Comme un CRC32 qui survit à la transmission réseau, la
              propriété résiste à toute transformation (coupe, mélange) car elle est encodée dans la
      ...
      >
        "Quand la Magie exécute du Code" — Devoxx 2026 - Marjorie Aubert et Nicolas Bétheuil
      </div>
    </div>
  );
}
